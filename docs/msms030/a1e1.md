---
Atelier: Découverte du tenant Microsoft 365
Duree: 20
---
...
1. **Mot de passe de l'administrateur du tenant**. Fourni par goDeploy, c'est le mot de passe du compte *MOD Administrator* et des utilisateurs précréés (sa valeur actuelle est "[MODPassword]").
...
1. Dans le navigateur, accédez au portail d'administration de Microsoft 365 en utilisant l'url `https://admin.microsoft.com`.  
    ...
    > Si vous rencontrez des soucis réseau dans les machines virtuelles goDeploy pour vous connecter sur l'environnement Microsoft 365, vous pouvez executer toutes les opérations à faire dans un navigateur Internet sur n'importe qul autre navigateur Internet en local.
...
1. Dans la fenêtre **Enter password**, saisissez ou collez le mot de passe du tenant **[MODPassword]** et cliquez sur **Sign in**
...
1. Restez connecté sur LON-DC1 et laissez votre navigateur Internet ouvert pour la tâche suivante de cet atelier.
