...
1. Dans la fenêtre **Organization information** qui s'affiche, modifiez l'information  **Technical contact** avec  l'adresse email du compte *MOD Administrator* : ```admin@[onmicrosoftDomain].onmicrosoft.com```.
