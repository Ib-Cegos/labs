---
Atelier: Configuration des services Exchange Online
---

# SParamètres de transport des messages
...
1. Dans le panneau **Set rule conditions** qui s'affiche, entrez les informations suivantes :  
	...
	- Sélectionnez **Dominique Skyetson** (dom@[godeployDomain].godeploylabs.com) dans la liste des boites aux lettres et cliquez sur **Save**.
...
1. Basculez sur l'onglet **Microsoft 365 admin center** et référez-vous aux procédures que vous avez utilisé à [l'atelier 2, exercice 5](a2e5#t%C3%A2che-3---v%C3%A9rification-de-la-d%C3%A9l%C3%A9gation-administrative) pour réinitialiser le mot de passe de **Megan Bowen** vers **Pa55w.rd**.
