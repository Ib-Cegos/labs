---
Atelier: Gestion des utilisateurs et des groupes Microsoft 365
---
# Gestion des utilisateurs avec le centre d'administration Microsoft 365
...
1. Dans la fenêtre licenses, cliquez sur la ligne **[365Licence]**.
1. Dans le panneau **[365Licence]**, cochez les cases en regard des utilisateurs suivant avant de cliquer sur **Unassign licenses** :
	...
	> Si, sur votre tenant, les licenses présentes sont **Office 365 E5 (no teams)** et non **[365Licence]**, merci d'adapter des énnonçés des ateliers en conséquence...
...
1. Sur la page **Set up the basics**, saisissez les informations suivantes :
	...
	- Username : `dom`  
		...
		> Après avoir configuré ce champ, le nom utilisateur de Dominique devrait apparaitre sous la forme: **dom@[onmicrosoftDomain].onmicrosoft.com**

	- Décochez l'option **Automatically create a password**
	- Password : ```[defaultPass]``` (Astuce : cliquez sur l'icône d'oeil à droite pour vérifier le mot de passe saisi)
...
1. Sur la page **Assign product licenses** , saisissez les informations suivantes:
	...
	- Licences : Vérifier que l'option **Assign user a product license** est sélectionnée et cochez les cases en regard des licences **[365Licence]**  et **Microsoft Teams Enterprise**
...
1. Sur la page **Dominique Skyetson added to active users**, cliquez sur **Show** à coté de **Password** pour vérifier que vous avez bien saisi correctement **[defaultPass]**.
1. En bas de la page, cliquez sur le lien **Add another user** et recommencez les étapes précédentes, pour ajouter les utilisateurs avec les informations suivantes :
	...
	- **Password :** Utilisez le mot de passe ```[defaultPass]```, et, comme pour le compte de Dominique, exigez le changement de mot de passe à la première connexion.
	- **Licenses :** Affectez une licence **[365Licence]** et une licence **Microsoft Teams Enterprise** à l'utilisateur **Alan Yoo**, en décochant l'App **Skype for Business Online (plan1)** comme vous l'avez fait pour Dominique Skyetson. Pour tous les autres utilisateurs, sélectionner l'option **Create user without product license (not recommended)**.
	...
	|----------------|---------------|------------------|--------------|-------------|----------|  
	| `Alan` | `Yoo` | Alan Yoo | `alan` | **Microsoft Teams Enterprise** et **[365Licence]** | **User** |  
...
1. Sur le panneau **Ada Russell** qui s'affiche, l'onglet **Licenses and apps** est affiché par défaut (puisque vous avez sélectionné l'option **Manage product licenses**). Sous la liste des licences, cliquez sur les cases **[365Licence]** et **Microsoft Teams Enterprise** avant de cliquer sur le bouton **Save changes**.  
