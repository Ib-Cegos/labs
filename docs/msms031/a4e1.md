---
Atelier: Configuration de la synchronisation d'identités
---

# Préparation de la synchronisation d'identités
...
L'environnement de test du pilote de Adatum que vous utilisez a été créé par votre hébergeur d'ateliers et le nom de domaine de l'ADDS choisi est **adatum.com**. Les utilisateurs ADDS ont donc été créés dans ce domaine qui ne sera pourtant pas celui utilisé pour l'environnement Entra Id de Adatum (le nom DNS d'entreprise *[godeployDomain].godeploylabs.com* sera utilisé à la place).  
