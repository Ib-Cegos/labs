---
Atelier: Mise en place de la M.F.A avec une application Windows
---
...
1. Sur la page du portail, cliquer sur l'information du compte (image/logo dans le coinb en haut à droite de la page) et cliquer sur le lien **View account**.
    ...
    > Un utilisateur peut accéder directement à sa page **My Account** en utilisant le lien suivant : `https://myaccount.microsoft.com`.  
...
1. Confirmer ce choix en cliquant sur le bouton **Ok**.
    ...
    > Vu que nous sommes dans un environnement de test/atelier, il n'y a aucune raison pour aller nettoyer les informations que nous avions entrées dans l'application **2fast**...  