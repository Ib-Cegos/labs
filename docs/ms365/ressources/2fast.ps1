if ([System.Security.Principal.WindowsIdentity]::GetCurrent().groups -match 'S-1-5-32-544') {
    ...
    Invoke-WebRequest "https://ib-cegos.github.io/labs/ms365/ressources/ibMFA.2fa" | Select-Object -ExpandProperty Content | Out-File "$([System.Environment]::GetFolderPath("MyDocuments"))\ibMFA.2fa"
